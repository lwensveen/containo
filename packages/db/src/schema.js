...
import { deliveryStatusEnum, itemStatusEnum, modeEnum, poolEventEnum, poolStatusEnum, } from './enums.js';
...
export const laneRates = pgTable('lane_rates', {
    id: uuid('id').primaryKey().defaultRandom(),
    originPort: text('origin_port').notNull(),
    destPort: text('dest_port').notNull(),
    mode: modeEnum('mode').notNull(),
...
export const webhookDeliveries = pgTable('webhook_deliveries', {
    ...
    pendingIdx: index('idx_webhook_deliveries_pending').on(t.status, t.nextAttemptAt, t.attemptCount),
}));
